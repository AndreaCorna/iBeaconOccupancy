...
/**
 * The class implements the version of application with the machine learning approach. The posts to the server of this version are done to the 
 * address <ip_of_server>/ibeaconserver
 * @author Andrea Corna - Lorenzo Fontana
 * @see BeaconHandler.java
 * @see Serializable
 */
public class MachineLearningHandlerImpl implements BeaconHandler,Serializable {
	...
	public MachineLearningHandlerImpl(boolean bluetoothSender){
		if(bluetoothSender){
			...
			communication = new HttpHandler(Constants.ADDRESS_LOGIC_MACHINE_LEARNING);
		}
	}
